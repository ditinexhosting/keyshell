...
<footer class="bg-[#333] text-white flex">
      ...
      <div class="flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="mt-4 md:mt-0 pl-0 md:pl-4">
          <ul class="flex space-x-4 flex-row md:flex-col lg:flex-row justify-center items-center gap-y-1">
            <li><a href="https://twitter.com" aria-label="Twitter" class="text-blue-400 pl-4"><i class="fab fa-twitter fa-lg"></i></a></li>
            <li><a href="https://instagram.com" aria-label="instagram" class="text-pink-400"><i class="fab fa-instagram fa-lg"></i></a></li>
            <li><a href="https://facebook.com" aria-label="facebook" class="text-blue-700"><i class="fab fa-facebook fa-lg"></i></a></li>
            <li><a href="https://youtube.com" aria-label="youtube" class="text-red-600"><i class="fab fa-youtube fa-lg"></i></a></li>
            <li><a href="https://pinterest.com" aria-label="pinterest" class="text-red-400"><i class="fab fa-pinterest fa-lg"></i></a></li>
          </ul>
        </div>
      </div>
  ...
  <span class="h-9 w-9 rounded-md bg-gray-600 text-white font-bold text-2xl text-center hover:bg-indigo-500 fixed bottom-5 right-5 block" id="ScrollToTop" onclick="topFunction()"><i class="fa-solid fa-angle-up"></i></span>

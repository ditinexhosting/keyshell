...
<section class="services px-5 sm:px-10 lg:px-20">
    <div class="main flex min-h-[60vh] flex-wrap justify-center items-center gap-x-3.5 md:gap-x-6 lg:gap-x-10 py-14">
        <div class="card flex flex-col gap-6 h-52 w-72 px-5" data-aos="fade-right">
            <img src="assets/icons/git.png" alt="" class="h-24 w-24">
        ...
        <div class="card flex flex-col gap-6 h-52 w-72 px-5" data-aos="fade-right">
            <img src="assets/icons/data-server.png" alt="" class="h-24 w-24">
            <h1 class="font-semibold text-lg">Server Monitoring</h1>
        </div>

        <div class="card flex flex-col gap-6 h-52 w-72 px-5" data-aos="fade-right">
            <img src="assets/icons/automation.png" alt="" class="h-24 w-24">
            <h1 class="font-semibold text-lg">Automate the server using tools such as Ansible, chef</h1>
        </div>

        <div class="card flex flex-col gap-6 h-52 w-72 px-5" data-aos="fade-right">
            <img src="assets/icons/icons8-hacker-64.png" alt="" class="h-24 w-24">
            <h1 class="font-semibold text-lg">Hack & Spamming Issue Investigation</h1>
        </div>

        <div class="card flex flex-col gap-6 h-52 w-72 px-5" data-aos="fade-right">
            <img src="assets/icons/icons8-training-48.png" alt="" class="h-24 w-24">
            <h1 class="font-semibold text-lg">Industrial Training</h1>
        </div>

        <div class="card flex flex-col gap-6 h-52 w-72 px-5" data-aos="fade-right">
            <img src="assets/icons/app-development.png" alt="" class="h-24 w-24">
            <h1 class="font-semibold text-lg">App development</h1>
        </div>

        <div class="card flex flex-col gap-6 h-52 w-72 px-5" data-aos="fade-right">
            <img src="assets/icons/world-wide-web.png" alt="" class="h-24 w-24">

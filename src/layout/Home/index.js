      ...
      <main className="container mx-auto bg-white">
            ...
            <div className="text-black flex flex-col gap-10">
              <div className="text-center">
                <h3 className="text-5xl font-bold">
                  30k
                  <sup className="text-primary font-extrabold">+</sup>
                </h3>
                <spna className="text-sm mt-7">Project Completed</spna>
              </div>
              <div className="text-center">
                <h3 className="text-5xl font-bold">70k</h3>
        ...
        <section className="bg-secondary px-5 mx-2 rounded-xl py-10">
          ...
          <section>
            <div className="flex justify-between items-baseline">
              <h2 className="text-5xl font-bold uppercase text-light-border">
                Project
              </h2>
            ...
            <div>
              <div className="flex items-center gap-2 justify-center md:justify-start py-8 flex-wrap md:flex-nowrap">
                <button className="border-2 border-light-border rounded-full px-4 py-1 text-light-border md:shrink-0">
                  Design
                </button>
                <button className="border-2 border-gray-white rounded-full px-4 py-1 text-gray-white md:shrink-0">
                  Development
                </button>
                <button className="border-2 border-gray-white rounded-full px-4 py-1 text-gray-white md:shrink-0">
                  Digital Marketing
                ...
                <div className="w-full h-[2px] bg-gray-white hidden md:block mx-2"></div>
              </div>
            </div>
            ...
            <div className="flex gap-10 flex-col md:flex-row">
              <div className="relative">
                <Image
                  ...
                  alt="Project"
                />
                <div className="absolute text-white text-lg p-5 transition-all opacity-0 hover:opacity-100  bg-red-900 bg-opacity-20 backdrop-blur-lg rounded drop-shadow-lg left-0 bottom-0">
                  <span className="block text-sm text-primary">Technology</span>
                  <p className="underline">
                    5 Exciting Tech Trends to Watch Out for in 2023
                  </p>
                </div>
              </div>
              <div className="relative">
        ...
        <section className="mb-32 text-black my-10" id='contact'>
          <div className="mb-9 md:mb-20 flex p-5">
            ...
            <div>
              <div className="p-2 bg-primary rounded-full animate-[spin_5s_linear_infinite]">
                <svg
            ...
            <div className="grow-0 shrink-0 basis-auto mb-6 md:mb-0 w-full md:w-6/12 px-3 lg:px-6">
              ...
              <div className="rounded-lg overflow-hidden w-fit mt-5 relative">
                ...
                <div className="absolute bottom-4 left-4 text-white text-lg p-5 transition-all opacity-0 hover:opacity-100">
                  ...
                  <p className="underline">
                    1st floor Carnival Infopark Phase1 Infopark, Kakkanad,

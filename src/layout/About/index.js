...
const index = () => {
  return (
    <>
      <section class="min-h-[60vh] md:min-h-[82vh] bg-no-repeat bg-cover bg-center bg-[url('/images/aboutUs-bgImage-min.webp')]">
        <div class="min-h-[65vh] md:min-h-[82vh] w-full flex flex-col justify-center items-center gap-8 sm:gap-12 px-4 md:px-16 lg:px-32">
          <h2 class="text-center font-bold text-3xl sm:text-4xl text-[#D8D8D8] tracking-wider">
            Welcome to Keyshell
          </h2>
          <p class="text-center text-md sm:text-xl font-semibold leading-relaxed text-gray-200 max-w-xl">
            In Keyshell, we spread knowledge and help youngsters familiarize
            themselves with the latest technologies. Experienced professionals
            provide the best technical education with advanced
            resources.Certified workshops and placement assistance are our key
            features.
          </p>
          <a
            href="#"
            class="relative z-10 px-6 py-3 font-medium text-white group"
          >
            <span class="absolute inset-0 w-full h-full transition-all duration-300 ease-out transform translate-x-0 -skew-x-12 bg-red-400 group-hover:bg-red-500 group-hover:skew-x-12"></span>
            <span class="absolute inset-0 w-full h-full transition-all duration-300 ease-out transform skew-x-12 bg-primary group-hover:bg-red-600 group-hover:-skew-x-12"></span>
      ...
      <div class="Text h-auto w-full py-10">
        <h2 class="text-center font-bold text-2xl md:text-4xl text-[#333]">
        ...
        <div class="min-h-[350px] w-full flex flex-col md:flex-row justify-center items-center gap-x-5 lg:gap-x-0">
          <div class="left h-[320px] sm:h-[350px] w-full md:w-2/5 flex justify-center items-center">
            <Image
              ...
              height={290}
              width={320}
              class="h-[290px] sm:h-[320px] w-[290px] sm:w-[320px]"
              loading="lazy"
            />
          </div>

          <div class="right min-h-[240px] md:h-[350px] w-full md:w-2/5 flex justify-center items-center">
            <p class="font-semibold text-lg md:text-xl text-[#333] max-w-[350px]">
      ...
      <section class="py-5 px-5 sm:px-10 lg:px-20">
        <div class="min-h-[350px] w-full flex flex-col-reverse md:flex-row justify-center items-center gap-x-5 lg:gap-x-0">
          <div class="left min-h-[240px] md:h-[350px] w-full md:w-2/5 flex justify-center items-center">
            <p class="font-semibold text-lg sm:text-xl text-[#333] max-w-[350px]">

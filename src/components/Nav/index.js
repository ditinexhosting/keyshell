                            ...
                            <div className="relative flex h-16 items-center justify-between">
                                <div className="absolute inset-y-0 right-0 flex items-center sm:hidden">
                                    ...
                                    <Disclosure.Button className="inline-flex items-center justify-center rounded-md p-2 bg-[#F61E1E] focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                                        ...
                                        {open ? (
                                            <Image src='/images/close-bold-svgrepo-com.svg' width={30} height={30} alt="Hamburger" />
                                        ) : (
                                            <Image src='/images/hamburger-menu-svgrepo-com.svg' width={30} height={30} alt="Hamburger" />
                                        )}
                                    </Disclosure.Button>
                                </div>

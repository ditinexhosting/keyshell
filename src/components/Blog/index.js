            ...
            <div className="border-2 border-gray-400 rounded-xl p-8 my-10 m-5">
                <div className="flex gap-10 flex-col md:flex-row">
                    <div className="relative">
                        ...
                        <div className="absolute bottom-4 left-4 text-white text-lg p-5 transition-all opacity-0 hover:opacity-100  bg-red-900 bg-opacity-20 backdrop-blur-lg rounded drop-shadow-lg left-0 bottom-0">

        ...
        <main className="container mx-auto bg-white">
            <div className='text-black p-4 md:p-0'>
                ...
                <div className="flex justify-between py-11 flex-col lg:flex-row gap-5 lg:gap-0">
                    ...
                    <div className="">
                        <button className="rounded-lg bg-[#F61E1E] p-3 px-5 font-bold text-lg text-white flex justify-center items-center gap-4  shadow-md hover:shadow-2xl transition-all">Get a <br />Quote
                            <svg className='animate-[spin_2s_linear_infinite]' width="42" height="39" viewBox="0 0 42 39" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <section className='bg-[#1C1C1C] px-5 mx-2 rounded-xl py-10'>
                <div className='flex justify-between flex-col md:flex-row gap-5 mb-5'>
                    <div className='flex flex-col'>
                        <h2 className='text-3xl md:text-5xl font-bold uppercase text-[#C4C4C4]'>Our Services <span className='text-[#F61E1E]'>.</span></h2>
                ...
                <div>
                    <Accordion
                        sections={[
                            {
                                title: (<>
                                    <h2 className='text-3xl md:text-5xl  font-bold uppercase flex gap-5 items-center'>UI/UX Design
                            ...
                            {
                                title: (<>
                                    <h2 className='text-3xl md:text-5xl  text-[#5F5F5F] uppercase flex gap-5 items-center'>Brand Design</h2>
                                </>),
                                content: (
                                    <p>
                            ...
                            {
                                title: (<>
                                    <h2 className='text-3xl md:text-5xl  text-[#5F5F5F] uppercase flex gap-5 items-center'>Graphic Design</h2>
                                </>),
                                content: (
                                    <p>

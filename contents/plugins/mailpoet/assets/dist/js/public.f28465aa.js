/*! For license information please see public.f28465aa.js.LICENSE.txt */ ! function(modules) {
    ...
    "use strict";
    var MailPoet = {};
    window.MailPoet = MailPoet, __webpack_exports__.a = MailPoet, __webpack_require__(35), __webpack_require__(37), __webpack_require__(38)
    ...
    var global = __webpack_require__(3),
        ...
        isForced = __webpack_require__(47),
        path = __webpack_require__(9),
        bind = __webpack_require__(24),
        createNonEnumerableProperty = __webpack_require__(25),
    ...
    var global = __webpack_require__(3),
        ...
        NATIVE_SYMBOL = __webpack_require__(31),
        USE_SYMBOL_AS_UID = __webpack_require__(60),
    ...
    var match, version, global = __webpack_require__(3),
        userAgent = __webpack_require__(58),
    ...
    (function(global) {
        module.exports = global._ = __webpack_require__(36)
    }).call(this, __webpack_require__(12))
}, function(module, exports, __webpack_require__) {
    var fails = __webpack_require__(4),
    ...
    var DESCRIPTORS = __webpack_require__(8),
        ...
        createElement = __webpack_require__(46);
    ...
    var DESCRIPTORS = __webpack_require__(8),
        definePropertyModule = __webpack_require__(26),
        createPropertyDescriptor = __webpack_require__(13);
    ...
    var IS_NODE = __webpack_require__(57),
        V8_VERSION = __webpack_require__(18),
        fails = __webpack_require__(4);
    ...
    var fails = __webpack_require__(4),
        wellKnownSymbol = __webpack_require__(17),
        V8_VERSION = __webpack_require__(18),
    ...
    var bind = __webpack_require__(24),
        IndexedObject = __webpack_require__(21),
        toObject = __webpack_require__(28),
        toLength = __webpack_require__(29),
        arraySpeciesCreate = __webpack_require__(30),
        push = [].push,
    ...
    var mailpoet__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0),
        ...
        underscore__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(20),
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).on("heartbeat-tick.mailpoet-ajax", (function(event, data) {
        ...
        init: function(options) {
            this.options = jquery__WEBPACK_IMPORTED_MODULE_1___default.a.extend({}, this.defaults, options), null === this.options.url && (this.options.url = window.ajaxurl), null === this.options.token && (this.options.token = window.mailpoet_token), null === this.options.timeout && (this.options.timeout = 0)
        },
        getParams: function() {
            return {
                action: "mailpoet",
        ...
        request: function(method, options) {
            ...
            return jquery__WEBPACK_IMPORTED_MODULE_1___default.a[method]({
                url: this.options.url,
                data: params,
                success: null,
                dataType: "json",
                timeout: this.options.timeout
            }).then(deferred.resolve, (function(failedXhr, textStatus) {
                var errorData, errorMessage, xhr;
    ...
    var parent = __webpack_require__(40);
    ...
    var entryVirtual = __webpack_require__(19);
    ...
    var $ = __webpack_require__(7),
        ...
        arraySpeciesCreate = __webpack_require__(30),
        arrayMethodHasSpeciesSupport = __webpack_require__(32),
        wellKnownSymbol = __webpack_require__(17),
        V8_VERSION = __webpack_require__(18),
    ...
    var DESCRIPTORS = __webpack_require__(8),
        propertyIsEnumerableModule = __webpack_require__(44),
        createPropertyDescriptor = __webpack_require__(13),
        toIndexedObject = __webpack_require__(45),
        toPrimitive = __webpack_require__(15),
        has = __webpack_require__(16),
        IE8_DOM_DEFINE = __webpack_require__(23),
    ...
    var IndexedObject = __webpack_require__(21),
        requireObjectCoercible = __webpack_require__(22);
    module.exports = function(it) {
    ...
    var global = __webpack_require__(3),
        setGlobal = __webpack_require__(55),
    ...
    "use strict";
    var $ = __webpack_require__(7),
        $find = __webpack_require__(33).find,
        addToUnscopables = __webpack_require__(68),
        SKIPS_HOLES = !0;
    ...
    "use strict";
    var $ = __webpack_require__(7),
        $map = __webpack_require__(33).map;
    $({
        target: "Array",
        proto: !0,
        forced: !__webpack_require__(32)("map")
    }, {
            ...
            Constraint.prototype = {
                ...
                _parseRequirements: function(options) {
                    ...
                    this.requirementList = this.validator.parseRequirements(this.requirements, (function(key) {
                        return options[_this.name + (str = key, str[0].toUpperCase() + str.slice(1))];
                        var str
                    }))
                }
            };
    ...
    external_jQuery_default()((function($) {
        function renderCaptcha(element, iteration) {
            ...
            } else iteration < 20 && setTimeout(renderCaptcha, 400, element, iteration + 1)
        }
        ...
        function showForm(formDiv) {
            ...
            delay = parseInt(delay, 10), is_nan_default()(delay) && (delay = 0);
        ...
        $(document).on("keyup", (function(e) {
            ...
            $(".mailpoet_form").each((function(index, element) {
            ...
            })), $(".mailpoet_form_close_icon").on("click", (function(event) {
                ...
                checkFormContainer(form.closest("div.mailpoet_form")), form.parsley().on("form:validated", (function() {
                    ...
                    if (formDiv && formDiv.data("is-preview")) return displaySuccessMessage(form), setTimeout((function() {
                        ! function(form) {
